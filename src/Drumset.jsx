  ...
  return (
    <div className="relative w-full overflow-x-hidden text-white">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.3fr_0.7fr]">
        ...
        >
          <div className="relative mx-auto aspect-4/3 w-full max-w-4xl overflow-hidden rounded-4xl border border-white/15 bg-[radial-gradient(circle_at_center,rgba(255,255,255,0.14),rgba(255,255,255,0.03)_45%,rgba(0,0,0,0.12)_100%)]">
